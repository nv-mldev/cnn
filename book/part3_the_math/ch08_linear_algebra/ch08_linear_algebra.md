...
**Next →** [Chapter 9 — Convolutions and Filtering](../../part4_learning_features/ch09_convolutions/README.md): Part IV begins — moving from comparing patches to learning features that are invariant to spatial transforms.
