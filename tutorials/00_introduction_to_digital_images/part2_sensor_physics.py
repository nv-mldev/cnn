...
Covers photosite size, well capacity, shot noise, and the SNR difference between phone
and DSLR sensors. Sensor physics (photosite size, well capacity, shot noise),
