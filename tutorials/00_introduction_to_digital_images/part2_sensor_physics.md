# Part 2: Sensor Physics — From Photons to Pixel Values

## Learning Objective

Understand what the sensor physically does to execute the sampling operation: how photons
become electrons, why shot noise is irreducible, and why photosite size determines SNR.
...
**Next:** Part 3 — What a pixel actually is, spatial resolution, and quantization.
